...
Los **30 productos del catálogo son de ejemplo** — nombres, descripciones y precios
referenciales. Reemplázalos por los reales en `assets/js/data.js`, en la lista
`PRODUCTOS`:
...
Para fotos de productos: crea la carpeta `assets/img/productos/` y agrega el campo
`img` a cada producto como se explicó arriba.
